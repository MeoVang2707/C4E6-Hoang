...
Nem = Food("Nem chua rán", "Món ăn đường phố nổi tiếng ở Việt Nam",
...
Food_list = [Pho, Banh_mi, Tra_da, Nem, Bun, Hu_tieu]
...
@app.route('/fav')
def fav():
    return render_template("fav.html", Food_list = Food_list)
